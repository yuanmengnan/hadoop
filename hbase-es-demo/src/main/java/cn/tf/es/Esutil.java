...
public class Esutil {
	...
	public static Map<String, Object> search(String key,String index,String type,int start,int row){
		...
		if(StringUtils.isNotBlank(key)){
		    //builder.setQuery(QueryBuilders.termQuery("title",key));     //注意：mapping必须是not_analyzed
		    //builder.setQuery(QueryBuilders.matchQuery("title",key));     //注意：mapping必须是not_analyzed
			//builder.setQuery(QueryBuilders.boolQuery().filter(QueryBuilders.termQuery("title",key)));
